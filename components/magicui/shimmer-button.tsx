 ...
 * Animated rotating shimmer border + glow. Use as primary CTA.
 */
    ...
    return (
      <button
        ...
        className={cn(
          ...
          'shadow-[0_8px_24px_-8px_rgba(236,30,121,0.55)] hover:shadow-[0_14px_32px_-10px_rgba(236,30,121,0.7)]',
          className
        )}
        {...props}
      >
        ...
        <div
          className={cn(
            ...
            'rounded-2xl px-4 py-1.5 text-sm font-medium shadow-[inset_0_-8px_10px_#ffffff12]',
